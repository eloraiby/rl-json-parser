...
#line 16 "C:/Users/Wael/Projects/json-parser/json-parser/parser.c"
...
#endif
#define parserARG_SDECL  json_parser_t* s ;
#define parserARG_PDECL , json_parser_t* s 
#define parserARG_FETCH  json_parser_t* s  = yypParser->s 
